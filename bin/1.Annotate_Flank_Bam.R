...
if (!is.null(repeatmasker_bed) && file.exists(repeatmasker_bed)) {
  ...
  if (any(has_site)) {
    ...
    if (length(hits) > 0) {
      ...
      df$repeat_family[hit_df$df_row] <- hit_df$repeat_family
    }
