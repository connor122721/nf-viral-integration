...
//
// Designed to plug into main_2.nf without disturbing the existing alignment
// and integration-calling stages. Include with:
//
//   include { POST_PROCESS } from './modules/post_process'
//
//   workflow {
//       ...
//       POST_PROCESS(integrations_ch, samplesheet_ch,
//                    repeats_t2t_ch, repeats_hg38_ch)
//   }
// ----------------------------------------------------------------------------
